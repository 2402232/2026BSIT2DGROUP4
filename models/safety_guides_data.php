<?php
/**
 * Shared safety guide content for list, detail, and PDF export.
 */
function get_safety_guides_catalog(): array
{
    return [
        'cpr-instructions' => [
...
function get_safety_guide_slugs(): array
{
    return array_keys(get_safety_guides_catalog());
}
