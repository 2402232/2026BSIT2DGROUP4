...
<div class="profile-page">
    <a class="back-link" href="<?php echo BASE_URL; ?>index.php?action=admin-dashboard">← Back to Dashboard</a>
    ...
    <div class="profile-card">
        ...
        <div class="role-wrap"><span class="role-badge">ADMINISTRATOR</span></div>

        <form action="<?php echo BASE_URL; ?>index.php?action=admin-update-profile" method="POST" enctype="multipart/form-data">
